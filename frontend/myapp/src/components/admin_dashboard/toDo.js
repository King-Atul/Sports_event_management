...
{
    return(
        <div className={`bg-[#303030] w-full h-max p-10 shadow-md shadow-gray-900 rounded-xl hover:bg-gray-1000 ${props.isdraggable && props.description.id === props.dragid ? "opacity-" : "opacity-100"}`} id={props.description.id}>
            <div className="flex flex-col items-start justify-center gap-4">
                <div className="flex flex-row items-center justify-center gap-4">
                    ...
                    <h1 className="text-white font-[Poppins] text-lg line-clamp-1 text-start">{props.description.title}</h1>
                </div>
                {/* <div className="flex flex-row items-center justify-center gap-4">
